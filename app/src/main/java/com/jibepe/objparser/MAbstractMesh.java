...
//import eu.myrpg.lepointd.lepointd.Vuforia.utils.MeshObject;

public abstract class MAbstractMesh {
    ...
    {
        return getBuffer(MAbstractMesh.BUFFER_TYPE.BUFFER_TYPE_VERTEX);
    }


    public Buffer getTexCoords()
    {
        return getBuffer(MAbstractMesh.BUFFER_TYPE.BUFFER_TYPE_TEXTURE_COORD);
    }


    public Buffer getNormals()
    {
        return getBuffer(MAbstractMesh.BUFFER_TYPE.BUFFER_TYPE_NORMALS);
    }


    public Buffer getIndices()
    {
        return getBuffer(MAbstractMesh.BUFFER_TYPE.BUFFER_TYPE_INDICES);
    }
    ...
    public abstract Buffer getBuffer(MAbstractMesh.BUFFER_TYPE bufferType);
