...
public class GameRecorder {
    ...
    private static final float ARENA_WIDTH = 768.0f;
    private static final float ARENA_HEIGHT = 1024.0f;
    ...
    public void prepareEncoder(Context context) {
        ...
        mOutputFile = new File(context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "video.mp4");
